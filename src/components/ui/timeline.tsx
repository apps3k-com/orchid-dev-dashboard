// Vertical timeline primitive from shadcnstudio (@ss-blocks/timeline-component-01 / -05):
// a CSS-grid rail with status dots + connecting lines. Used to render the PR activity feed in
// the pull-request detail modal. Kept faithful to the registry source (formatted to match ui/*).
